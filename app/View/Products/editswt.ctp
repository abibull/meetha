                    ...
                    <div class="row">
                        ...
                        <?php echo $this->Form->create('Product' , array('class' => 'form' , 'inputDefaults' => array('label' => false))); ?>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    <?php echo $this->Form->submit('Update',array('class'=>'btn btn-primary btn-block'));?>
                                </div>
                                <div class="form-group">
                                    <?php echo $this->Html->link('Show Sweet List',array('controller'=>'products','action'=>'swtlst'),array('class'=>'btn btn-info btn-block'));?><!--a class="btn btn-danger btn-block" href="/meetha/products/index">Cancel</a-->
                                </div>
                            </div>
